...
if __name__ == "__main__" :
    ...
    parser.add_argument("--OUTPUT", type=str, default='./ckpt/Video_EgoCrash_slowfast',
    ...
    train_parser.add_argument("--LOG", type=str, default='./tensorboard/Video_EgoCrash_slowfast')

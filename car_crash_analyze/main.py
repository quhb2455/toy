...
if __name__ == "__main__" :
    ...
    parser.add_argument("--MODEL_NAME", type=str, default='eva_large_patch14_336')#slowfast
    parser.add_argument("--NUM_CLASSES", type=int, default=3)

    parser.add_argument("--IMG_PATH", type=str, default="./data/50frame_train/*")
    parser.add_argument("--CSV_PATH", type=str, default="./data/50f_weather_0.35Normal_train.csv",
                        help='For test, using sample_submission.csv file')
    parser.add_argument("--OUTPUT", type=str, default='./ckpt/50f_weather_0.35Normal_evaLargeP14_336',
    ...
    train_parser.add_argument("--LOG", type=str, default='./tensorboard/50f_weather_0.35Normal_evaLargeP14_336')
    train_parser.add_argument("--REUSE", type=bool, default=True)

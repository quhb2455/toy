...
class MultiHeadBaseModel(nn.Module) :
    def __init__(self, **cfg) -> None:
        ...
        in_dim = list(self.backbone.children())[-1].in_features
        self.linear_1 = FullyConnectedLayer(in_dim, 64, 6)
        self.linear_2 = FullyConnectedLayer(in_dim, 64, 5)
        self.linear_3 = FullyConnectedLayer(in_dim, 64, 3)
    ...
    def forward(self, x, div=False): 
        ...
        if div :
            return self.linear_1(emb), self.linear_2(emb), self.linear_3(emb), emb
        else :
            return self.linear_1(emb), self.linear_2(emb), self.linear_3(emb)

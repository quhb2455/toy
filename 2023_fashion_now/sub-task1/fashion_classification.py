...
class BaseMain(Trainer, Predictor, DatasetCreater) :
    def __init__(self, **cfg) -> None:
        ...
        in_dim = list(self.model.model.children())[-1].in_features
        self.d_head = FullyConnectedLayer(in_dim, 64, 6).to(cfg["device"])
        ...
        self.optimizer = Adam([
            ...
            {"params" : self.e_head.parameters()},], lr=cfg["learning_rate"])

    ...
    def get_data(self, **cfg) :
        ...
        if mode == "infer" :
            ...
            for df in infer_csv.iloc :
                ...
                i_label_list.append([df['Daily'], df['Gender'], df['Embellishment']])
            ...
            for df in train_csv.iloc :
                ...
                t_label_list.append([df['Daily'], df['Gender'], df['Embellishment']])
            ...
            for df in valid_csv.iloc:
                ...
                v_label_list.append([df['Daily'], df['Gender'], df['Embellishment']])

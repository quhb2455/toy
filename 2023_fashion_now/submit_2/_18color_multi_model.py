...
class BaseMain(Trainer, Predictor, DatasetCreater) :
    ...
    def merge_csv(self, **cfg) :
        ...
        return self.save_to_csv(pred_list, **cfg)
    
    
if __name__ == "__main__" :
    
    cfg = {
        "mode" : "infer", #train, #infer #merge
        ...
        "weight_path" : "./sub-task2/ckpt/seresnext50_32x4d/YCrCb_3_group/63E-val0.6227062319989951-seresnext50_32x4d.pth",
        
        "save_path" : "./sub-task2/ckpt/seresnext50_32x4d/YCrCb_3_group",
        "output_path" : "./sub-task2/output/seresnext50_32x4d/YCrCb_3_group",

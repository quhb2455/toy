...
class Trainer() :
    def __init__ (self, model, optimizer, criterion, device, args) :
        ...
        self.train_loader ,self.val_loader = self.get_dataloader(args.CSV_PATH, args.BATCH_SIZE)
    ...
    def get_dataloader(self, csv_path, batch_size):
        train_df, val_df, train_labels, val_labels = divided_train_val(read_csv(csv_path))
        return train_and_valid_dataload((train_df, val_df), (train_labels, val_labels), batch_size=batch_size)
